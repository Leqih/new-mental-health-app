    ...
    const moodCharSVG = (mood) => {
      ...
      const cloud = (fill, face) => `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:100%"><circle cx="36" cy="56" r="24" fill="${fill}"/><circle cx="52" cy="44" r="28" fill="${fill}"/><circle cx="68" cy="56" r="22" fill="${fill}"/><rect x="19" y="56" width="62" height="22" rx="11" fill="${fill}"/>${face}</svg>`;
      if (s === 'good') return cloud('#7dd87c', `<circle cx="42" cy="58" r="4.5" fill="#1a2a1a"/><circle cx="60" cy="58" r="4.5" fill="#1a2a1a"/><circle cx="43.7" cy="56.5" r="1.6" fill="white"/><circle cx="61.7" cy="56.5" r="1.6" fill="white"/><path d="M40 67 Q51 75 62 67" stroke="#1a2a1a" stroke-width="2.8" fill="none" stroke-linecap="round"/>`);
      if (s === 'happy') return cloud('#f0d050', `<path d="M37 55 Q41 51 45 55" stroke="#2a2000" stroke-width="2.5" fill="none" stroke-linecap="round"/><path d="M57 55 Q61 51 65 55" stroke="#2a2000" stroke-width="2.5" fill="none" stroke-linecap="round"/><path d="M38 65 Q51 76 64 65" stroke="#2a2000" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M38 65 Q51 76 64 65 L64 70 Q51 80 38 70 Z" fill="#e05030" opacity="0.8"/>`);
      if (s === 'grateful') return cloud('#f5be78', `<circle cx="42" cy="58" r="4.8" fill="#3a1a00"/><circle cx="60" cy="58" r="4.8" fill="#3a1a00"/><circle cx="43.8" cy="56.5" r="1.8" fill="white"/><circle cx="61.8" cy="56.5" r="1.8" fill="white"/><path d="M40 68 Q51 75 62 68" stroke="#3a1a00" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M26 40 L28 35 L30 40 L35 38 L31 41 L33 46 L28 43 L23 46 L25 41 L21 38 Z" fill="#ff9020" opacity="0.9"/>`);
      if (s === 'angry') return cloud('#ff7070', `<path d="M36 51 L42 46 L47 51" stroke="#3a0000" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/><path d="M55 51 L61 46 L66 51" stroke="#3a0000" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/><circle cx="42" cy="57" r="4.5" fill="#3a0000"/><circle cx="60" cy="57" r="4.5" fill="#3a0000"/><path d="M40 67 Q51 63 62 67" stroke="#3a0000" stroke-width="2.5" fill="none" stroke-linecap="round"/>`);
      if (s === 'exhausted') return cloud('#b4a0e8', `<path d="M37 53 L45 61 M45 53 L37 61" stroke="#1a0a3a" stroke-width="2.8" stroke-linecap="round"/><path d="M57 53 L65 61 M65 53 L57 61" stroke="#1a0a3a" stroke-width="2.8" stroke-linecap="round"/><path d="M39 70 Q43 66 47 69 Q51 72 55 68 Q59 64 63 68" stroke="#1a0a3a" stroke-width="2.5" fill="none" stroke-linecap="round"/>`);
      if (s === 'boring') return cloud('#40c8c0', `<line x1="38" y1="56" x2="46" y2="56" stroke="#002a28" stroke-width="2.5" stroke-linecap="round"/><line x1="56" y1="56" x2="64" y2="56" stroke="#002a28" stroke-width="2.5" stroke-linecap="round"/><path d="M40 67 Q51 64 62 67" stroke="#002a28" stroke-width="2.5" fill="none" stroke-linecap="round"/>`);
      if (s === 'anxious') return cloud('#ff82aa', `<circle cx="42" cy="57" r="5.5" fill="#2a001a"/><circle cx="60" cy="57" r="5.5" fill="#2a001a"/><circle cx="44" cy="55.2" r="2.2" fill="white"/><circle cx="62" cy="55.2" r="2.2" fill="white"/><path d="M39 68 Q43 65 47 68 Q51 71 55 68 Q59 65 63 68" stroke="#2a001a" stroke-width="2.5" fill="none" stroke-linecap="round"/>`);
      return cloud('#7bc8f0', `<circle cx="42" cy="58" r="4.5" fill="#1a1a3a"/><circle cx="60" cy="58" r="4.5" fill="#1a1a3a"/><circle cx="43.7" cy="56.5" r="1.6" fill="white"/><circle cx="61.7" cy="56.5" r="1.6" fill="white"/><path d="M40 70 Q51 63 62 70" stroke="#1a1a3a" stroke-width="2.8" fill="none" stroke-linecap="round"/><ellipse cx="38" cy="66" rx="2.2" ry="3.5" fill="#50b8f0" opacity="0.85"/>`);
    };
