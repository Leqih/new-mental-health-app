    ...
    const MOOD_CARD_GRADIENT = {
      Good:      'linear-gradient(135deg, #C0EAC8, #CEEEA8, #E0F0A8, #CEEEA8, #C0EAC8)',
      Happy:     'linear-gradient(135deg, #F8EDB8, #F8D8B8, #F8CCB8, #F8D8B8, #F8EDB8)',
      Grateful:  'linear-gradient(135deg, #F8DEBB, #F8C4C4, #EEB8CC, #F8C4C4, #F8DEBB)',
      Sad:       'linear-gradient(135deg, #BCCEF6, #CAC4F0, #D8B8EA, #CAC4F0, #BCCEF6)',
      Anxious:   'linear-gradient(135deg, #F4C8D8, #E4C0EC, #CEC0F6, #E4C0EC, #F4C8D8)',
      Angry:     'linear-gradient(135deg, #F4BCBC, #F4D4B8, #F4EAB8, #F4D4B8, #F4BCBC)',
      Exhausted: 'linear-gradient(135deg, #D8BEF0, #C0C0EC, #BAD0EC, #C0C0EC, #D8BEF0)',
      Boring:    'linear-gradient(135deg, #C8EAE6, #C8DCEE, #D4D8EE, #C8DCEE, #C8EAE6)',
    };
        ...
        return (
          <>
            ...
            <div style={{ position:'absolute', left:'50%', marginLeft:-143.5, top: mgr ? 220 : man ? 215 : mh ? 205 : 195, width:287, height:287 }}>
              <div style={{ position:'relative', width:'100%', height:'100%', animation:ca }}
                dangerouslySetInnerHTML={{ __html: buildIconHTML(moodId) }} />
              {ms && <>
                <div style={{ position:'absolute', width:5, height:9, borderRadius:'50% 50% 50% 50% / 40% 40% 60% 60%', background:'#58c2ff', left:115, top:163, animation:'tearFall 2s ease-in 0s   infinite' }} />
                <div style={{ position:'absolute', width:5, height:9, borderRadius:'50% 50% 50% 50% / 40% 40% 60% 60%', background:'#58c2ff', left:115, top:163, animation:'tearFall 2s ease-in 1s   infinite' }} />
                <div style={{ position:'absolute', width:5, height:9, borderRadius:'50% 50% 50% 50% / 40% 40% 60% 60%', background:'#58c2ff', left:167, top:163, animation:'tearFall 2s ease-in 0.5s infinite' }} />
                <div style={{ position:'absolute', width:5, height:9, borderRadius:'50% 50% 50% 50% / 40% 40% 60% 60%', background:'#58c2ff', left:167, top:163, animation:'tearFall 2s ease-in 1.5s infinite' }} />
              </>}
            </div>
          </>
        );
